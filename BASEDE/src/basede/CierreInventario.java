...
public class CierreInventario {
    ...
    private void realizarCierreInventario() {
        ...
        String insertAjusteSQL = "INSERT INTO AJUSTES (AJUCODIGO, AJUFECHA, AJUDESCRIPCION) VALUES (?, CURDATE(), ?)";
        String insertPXASQL = "INSERT INTO PXA (PROCODIGO, AJUCODIGO, PXADESCRIPCION, PXAUNIDADMEDIDA, PXAFECHA, PXASALDOINICIAL, PXAINGRESOS, PXAEGRESOS, PXAAJUSTES, PXASALDOFINAL, PXASALDOFISICO, PXASALDOTOTAL) " +
                              "SELECT p.PROCODIGO, ?, p.PRODESCRIPCION, p.PROUNIDADMEDIDA, CURDATE(), p.PROSALDOINICIAL, p.PROINGRESOS, p.PROEGRESOS, p.PROAJUSTES, p.PROSALDOFINAL, COALESCE(p.PROSALDOFISICO, 0), (p.PROSALDOFINAL - COALESCE(p.PROSALDOFISICO, 0)) " +
                              "FROM PRODUCTOS p";
        ...
        try {
            ...
            String ajusteCodigo = "AJ-" + String.format("%05d", System.currentTimeMillis() % 100000);
